...
namespace Utils
{
    ...
    {
        public static void RandomRange(this ref int value, int _min, int _max)
        {
            if (_min == _max - 1)
            {
                value = _min;
            }
            value = UnityEngine.Random.Range(_min, _max - 1);
        }

        public static void RandomRange(this ref float value, float _min, float _max)
        {
