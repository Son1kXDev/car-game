...
public class ButtonAutoFit : Button
{
    ...
    {
        private readonly UxmlIntAttributeDescription minFontSize = new UxmlIntAttributeDescription
        {
            name = "min-font-size",
            defaultValue = 10,
        ...
        private readonly UxmlIntAttributeDescription maxFontSize = new UxmlIntAttributeDescription
        {
            name = "max-font-size",
            defaultValue = 200,
            restriction = new UxmlValueBounds { min = "1" }
        ...
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
        {
            ...
            ButtonAutoFit instance = ve as ButtonAutoFit;
