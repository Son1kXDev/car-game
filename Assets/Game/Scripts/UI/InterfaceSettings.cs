...
namespace Assets.Game.Scripts.UI
{
    ...
    {
        [SerializeField, StatusIcon] private TMP_Dropdown _languageDropdown;
        [SerializeField, StatusIcon] private TMP_Dropdown _speedDropdown;
        [SerializeField, StatusIcon] private TMP_Dropdown _temperatureDropdown;
